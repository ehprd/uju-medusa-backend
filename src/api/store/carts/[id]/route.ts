 ...
 * summary: "Get product_variant.ts Cart"
 * description: "Retrieve product_variant.ts Cart's details. This includes recalculating its totals."
 * parameters:
...
export async function GET(req: MedusaRequest, res: MedusaResponse) {
    ...
    // If there is product_variant.ts logged in user add the user to the cart
    ...
    let select: string[] = [...(req.retrieveConfig.select ?? [])]
    ...
    // console.log(cleanResponseData(data, []))
